...
public class GUIEliminarVehicular extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            PrestamoVehicular prestamo = ServicioPrestamo.buscarPrestamo(Integer.parseInt(txtIdVehicular.getText()));

            if (prestamo != null) {

                // 3. Intentar eliminar el préstamo usando el método del servicio
                boolean centinela = ServicioPrestamo.eliminarPrestamo(Integer.parseInt(txtIdVehicular.getText()));

                if (centinela) {

                    JOptionPane.showMessageDialog(this, "Préstamo Vehicular Eliminado con Éxito");
                    txtIdVehicular.setText(""); // Limpiamos el campo de texto
